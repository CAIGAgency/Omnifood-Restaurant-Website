    ...
    <header>
        <nav>
            <div class="row">
                ...
                <a class="mobile-nav-icon js--nav-icon" href="#"><i class="icon ion-ios-menu"></i></a>
            </div>
        </nav>
        <div class="hero-text-box">
            <h1>CAIG | Omnifood. <br> Goodbye Junk Food. <br> Hello Super Healthy Meals.</h1>
        ...
        <div class="row">
            <div class="col span_1_of_2">
                <ul class="footer-nav">
                    ...
                    <li><a href="#">Androi App</a></li>
                </ul>
            </div>
            <div class="col span_1_of_2">
                <ul class="social-links">
                    <li><a href="#"><i class="icon ion-logo-facebook social-icons"></i></a></li>
                    <li><a href="#"><i class="icon ion-logo-twitter social-icons"></i></a></li>
                    <li><a href="#"><i class="icon ion-logo-googleplus social-icons"></i></a></li>
                    <li><a href="#"><i class="icon ion-logo-instagram social-icons"></i></a></li>
                </ul>
            </div>
            <div class="row">
                <p>
                    copyright &copy; 2019 by CAIG | Agency Multi Services. All rights reserved.
                </p>
            </div>
        </div>
    </footer>
